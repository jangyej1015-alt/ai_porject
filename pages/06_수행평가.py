...
data = [
    ...
    ["남자","지창욱","최악의 악","범죄액션",2023],
    ["남자","안효섭","너의 시간 속으로","판타지로맨스",2023],
    ["남자","유연석","운수 오진 날","스릴러",2023],

    ["남자","유연석","지금 거신 전화는","미스터리로맨스",2024],

    ["여자","채수빈","반의반","로맨스",2020],

    ["여자","김고은","유미의 세포들","로맨틱코미디",2021],
    ["여자","한소희","알고있지만","로맨스",2021],
    ["여자","한소희","마이 네임","액션느와르",2021],

    ["여자","채수빈","너와 나의 경찰수업","청춘로맨스",2022],
    ["여자","김고은","유미의 세포들2","로맨틱코미디",2022],
    ["여자","김고은","작은 아씨들","미스터리",2022],
    ["여자","한소희","사운드트랙 #1","로맨스",2022],

    ["여자","한소희","경성크리처","판타지스릴러",2023],

    ["여자","채수빈","지금 거신 전화는","미스터리로맨스",2024],
]
...
trend = (
    ...
    .size()
    .reset_index(name="작품수")
    .sort_values("작품수", ascending=False)
)
